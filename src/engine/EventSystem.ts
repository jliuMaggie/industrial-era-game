...
export function checkEraTransition(state: GameState): boolean {
  ...
  // Asset thresholds for early era transition (must be very high to prevent premature crossing)
  const thresholds: Record<Era, number> = {
    1: 500_000_000,      // Era 1: 5亿
    2: 50_000_000_000,   // Era 2: 500亿
    3: 500_000_000_000,  // Era 3: 5000亿
    4: VICTORY_ASSET_TARGET, // Era 4: 1万亿 = victory
  };
